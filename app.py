        ...
        try:
            ...
            if 's_mag_range_41' in request.form:
                ...
                for i in range(s_mag_range_41,e_mag_range_41,step_41):
                    search_query = "SELECT count(*) FROM all_month WHERE mag BETWEEN " + str(float(i)) + " AND " + str(float(i+step_41))
            ...
            if 's_mag_range_42' in request.form:
                ...
                for i in range(s_mag_range_42,e_mag_range_42,step_42):
                    search_query = "SELECT count(*) FROM all_month WHERE mag BETWEEN " + str(float(i)) + " AND " + str(float(i+step_42))
            ...
            if 'recent_quake_43' in request.form:
                ...
                search_query = "SELECT TOP "+ str(recent_quake_43) +" mag,depth FROM all_month order by time desc"
            ...
            if 'histogram_44' in request.form:
                ...
                search_query = "SELECT mag FROM all_month WHERE 1=1"
